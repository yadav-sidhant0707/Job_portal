				...
				<div class="card">
					<div class="card-body">
						...
						<input type="hidden" value="<%=j.getId() %>" name="id">
							...
							<label>Enter Title</label><input type="text" required class="form-control" name="title"  value="<%=j.getTitle() %>">
							</div>
							...
							<div class="form-group">
								...
								<textarea required row="6" cols="" name="desc" class="form-control"><%=j.getDescription() %></textarea>
							</div>
